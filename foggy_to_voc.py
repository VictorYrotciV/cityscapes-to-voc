...
#arguments
#----------
# cityscapes_dir = '/data/yhz/cityscapes'
# save_path = '/data/yhz/cityscape/'
cityscapes_dir = '/data/yhz/foggy_cityscapes/'
save_path = '/data/yhz/foggy_cityscape/'
        ...
        for file in files:
            ...
            for beta in ['0.01','0.02','0.005']:
                if relevant_file:
                    ...
                    # print(base_filename)
                    xml_filepath = os.path.join(ann_dir,base_filename + '_leftImg8bit'+'_foggy_beta_'+beta+'.xml')
                    img_name = base_filename+'_leftImg8bit'+'_foggy_beta_'+beta+'.png'
                    img_path = os.path.join(cityscapes_dir, 'leftImg8bit_foggy', category, city, base_filename+'_leftImg8bit'+'_foggy_beta_'+beta+'.png')
